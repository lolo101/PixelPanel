...
## Requirements
This application uses Structured Concurrency preview feature of Java 26 ([JEP 525](https://openjdk.org/jeps/525)). 

Therefore, it is required for it to run on a JRE 26.
...
The relation between thoses two fractals is such : if the selected point of the Mandelbrot set is non-zero (colored) then the Julia set will display a nice fractal. If the selected point is zero (black), then the Julia set will be a *Fatou dust* or *Cantor set* and is not very interesting 🙂
